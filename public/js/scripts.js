...
$(function () {
  ...
  $('body').on('change', '.courses-filter select', function () {
    ...
    const filterFunc = filterType === 'age' ? (i, el) => $(el).data(filterType) <= filterVal : (i, el) => $(el).data(filterType) == filterVal;
...
$.fn.filterData = function (key, value, equality) {
  return this.filter(function () {
    return equality ? $(this).data(key) == value : $(this).data(key) != value;
  });
};
